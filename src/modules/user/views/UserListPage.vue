...
<template>
  <div class="relative">
      ...
      <s-table>
        ...
        <s-table-body class="relative">
          ...
          <s-table-row v-else-if="!items.length && hasChangeFilter">
            <s-table-cell colspan="5" class="py-16">
              <s-search-not-found></s-search-not-found>
            </s-table-cell>
          </s-table-row>

          <s-table-row v-else-if="!items.length">
            <s-table-cell colspan="5" class="py-16">
              <s-no-data @createNew="isShowCreateModal = true"></s-no-data>
            </s-table-cell>
          </s-table-row>
                ...
                >
                  ...
                  <template v-slot:content="{ onClose }">
                    <span
                      ...
                      "
                      class="block pb-3 text-gray-900 cursor-pointer"
                    >
                      Change password
                    </span>
                    <div v-else class="block pb-3 text-gray-900">
                      <s-tooltip content="User not permission" :hover="true">
                    ...
                    <span
                      ...
                      "
                      class="block pt-3 text-danger border-t border-gray-300 cursor-pointer"
                    >
                      Delete
                    </span>
                    <div
                      v-else
                      class="block pt-3 text-danger border-t border-gray-300"
                    >
                      <s-tooltip content="User not permission" :hover="true">
    ...
    <s-modal v-if="isShowFilterModal" @close="isShowFilterModal = false">
      <template #header>
        <h4 class="uppercase text-gray-900">Filter</h4>
      </template>
      <template #body>
        <div class="space-y-5">
          <div>
